export const About = () => {
  return (
    <>
      ...
      {/* about us */}
      <div className="relative flex items-center md:h-full xl:h-screen h-[400px]">
        <div className="absolute  text-left text-white m-6 sm:m-12 md:m-24   z-10">
          ...
          <p className="text-4xl sm:text-5xl lg:text-7xl uppercase mt-5 font-bold tracking-wider">
            To redefine
          </p>
          <p className="text-4xl sm:text-5xl lg:text-7xl uppercase font-bold tracking-wider">
            precision & trust
          </p>
          <p className="text-sm sm:text-base md:text-xl w-full sm:w-[70%] lg:w-[35%] mt-6 sm:mt-10">
        ...
        <img
          src="/vision.jpg"
          alt=""
          className="w-full h-full object-cover brightness-50 xl:brightness-100 z-0 "
        />
      </div>
    </>
  );
